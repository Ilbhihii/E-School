(function () {
    function initStudentAssignmentPage() {
        const pathData =
        ...
        function showClassPlaceholder(message) {
            if (
                !classSelect
                || !classSelectWrap
                || !autoClass
        ...
        function fillClasses(
            ...
            const levelId =
                String(levelSelect.value || '');

            if (!subjectId) {
                showClassPlaceholder(
        ...
        if (
             ...
             * Cela fonctionne même si le navigateur a déjà
             * déclenché DOMContentLoaded.
             */
            fillLevels(
