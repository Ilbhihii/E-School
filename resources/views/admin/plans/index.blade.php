                    ...
                    <tbody>
                        @foreach($plans as $plan)
                            <tr>
                                    ...
                                    <div class="plan-name-cell">
                                        ...
                                        <div>
                                            <div class="plan-name-line">
                                                ...
                                                @endif
                                                @if($plan->is_family_pack)
                                                    <span class="plan-chip family">
                                                        <i class="bi bi-people-fill"></i>
                                                        Family · {{ $plan->family_members ?: 4 }} membres
                                                    </span>
                                                @endif
                                            </div>
                                ...
                                <td>
                                    @php
                                        $shortPrices = collect($plan->pricing_options)
                                            ->filter(function ($pricing) {
                                                return (int) ($pricing['duration_months'] ?? 12) < 12;
                                            })
                                    ...
                                    <div class="plan-price-cell">
                                        ...
                                        @if($shortPrices->isNotEmpty())
                                            <small>
                                                Mensuel :
                                                {{ $shortPrices->map(function ($pricing) use ($plan) {
                                                    return $pricing['duration_months'] . 'm ' . $pricing['amount_display'] . ' ' . $plan->currency_symbol;
                                                })->implode(' · ') }}
                                            </small>
                                        @endif
                                    </div>
