...
<div class="adm-page-header">
    <div>
        <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;font-size:0.8rem;color:var(--adm-text-muted);">
            ...
            <span>/</span>
            <a href="{{ route('admin.subjects.classes', [$subject, $level]) }}" style="color:var(--adm-text-muted);text-decoration:none;">{{ $level->name }}</a>
            <span>/</span>
    ...
    <div class="page-actions">
        ...
        <a href="{{ route('admin.subjects.classes', [$subject, $level]) }}" class="adm-btn adm-btn-ghost">
