...
<div class="container py-5">
    ...
    <div class="hero-header text-center mb-5 p-5 rounded-5 animate__animated animate__fadeIn" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; box-shadow: 0 20px 40px rgba(102, 126, 234, 0.3);">
        ...
        <div class="badge bg-light text-dark fs-6 px-3 py-2 animate__animated animate__pulse animate__infinite mb-2">
            🏫 Classe : {{ $course->classRoom->name ?? '-' }}
        </div>
        <div class="badge bg-primary text-white fs-6 px-3 py-2 animate__animated animate__pulse animate__infinite">
            📚 Matière : {{ $course->subject->name ?? '-' }}
        </div>
    </div>
