class Course {
  ...
  factory Course.fromJson(Map<String, dynamic> json) {
    return Course(
      ...
      videoUrl: (json['resource_endpoints'] as Map?)?['video'] as String?,
      video: null,
      pdf: (json['resource_endpoints'] as Map?)?['pdf'] as String?,
      courseLink: (json['resource_endpoints'] as Map?)?['link'] as String?,
