        ...
        <div>
            ...
            <div class="rgc-hero-main">
                ...
                <div>
                    ...
                    <p>
                        Discussion privée enseignant ↔ étudiant
                        pour {{ $subject->name }}.
                    </p>
                </div>
            </div>
    ...
    <div class="rgc-layout">
        <aside class="rgc-side">
            ...
            <div class="rgc-person-list">
                <div class="rgc-person">
                    ...
                    <i class="bi bi-person-fill-lock rgc-person-active"></i>
                </div>
            </div>
            ...
            <div class="rgc-actions">
                <a href="{{ route('prof.private-chats.index') }}">
                    <i class="bi bi-person-lines-fill"></i>
                    <span>Messages privés</span>
                    <i class="bi bi-chevron-right"></i>
                </a>

                <a href="{{ route('prof.chat.subjects') }}">
        ...
        <section class="rgc-chat">
                        ...
                        @foreach($dayMessages as $message)
                            @php
                                ...
                                $author =
                                    $own
                                        ? 'Vous'
                                        : ($message->user?->name ?? 'Étudiant');

                                $authorInitials =
                                    collect(
                                        preg_split(
                                            '/\s+/u',
                                            trim($message->user?->name ?? 'Étudiant')
                                        )
                                    )
                                    ->filter()
                                    ->take(2)
                                    ...
                                    <div class="rgc-bubble">
                                        ...
                                        <footer>
                                            ...
                                            @if($own)
                                                ...
                                                <form
                                                    method="POST"
                                                    action="{{ route('prof.private-chats.delete', ['student' => $other->id, 'subject' => $subject->id]) }}"
            ...
            <footer class="rgc-composer">
                <form
                    method="POST"
                    action="{{ route('prof.private-chats.send', ['student' => $other->id, 'subject' => $subject->id]) }}"
                    data-rgc-form
                >
                    @csrf
