    ...
    <div>
        ...
        <div class="subtitle">
            @if($course->classRoom ?? false)
                <span class="info-chip me-3"><i class="bi bi-building me-1" style="color:#06B6D4;"></i> {{ $course->classRoom->name }}</span>
            @endif
            @if($course->subject ?? false)
                <span class="info-chip"><i class="bi bi-book me-1" style="color:#A78BFA;"></i> {{ $course->subject->name }}</span>
            @endif
        </div>
    </div>
    <div class="page-actions">
        <a href="{{ route('admin.courses.edit', $course->id) }}" class="adm-btn adm-btn-warning">
...
<div class="row g-4">
    <div class="col-lg-8">
        ...
        <div class="adm-card mb-4">
            <div class="adm-card-header">
                <h4><i class="bi bi-clipboard-check" style="color:#4ADE80;"></i> Devoirs associés ({{ $course->devoirs->count() }})</h4>
            </div>
