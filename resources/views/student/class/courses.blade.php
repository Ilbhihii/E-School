...
<div class="container py-5">
    <div class="glassmorphism-hover mb-5 p-4 rounded-5 text-center">
        <h1 class="display-5 fw-bold mb-3" style="background: var(--gradient-green); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
            <i class="bi bi-play-circle me-3"></i>Cours de {{ $class->name }}
        </h1>
        <p class="lead text-muted mb-0 animate-fade-in">Matière #{{ $subject_id }} - Explorez les leçons disponibles</p>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <a href="{{ route('student.course.show', $course->id) }}" class="text-decoration-none">
                <div class="card h-100 class-card-modern hover-lift rounded-5 border-0 overflow-hidden position-relative">
                    ...
                    <div class="banner-modern position-relative overflow-hidden" style="height: 220px;">
                        <div style="height:100%; background: linear-gradient(135deg, hsl({{ rand(0,360) }},70%,60%), hsl({{ rand(0,360) }},70%,40%)), linear-gradient(45deg, transparent 30%, rgba(255,255,255,0.1) 50%, transparent 70%); background-size: 200% 200%; animation: shimmer 3s infinite;">
                        </div>
                    ...
                    <div class="card-body p-4 text-center">
                        ...
                        <span class="badge course-badge px-3 py-2 fw-semibold animate-pulse">
                            <i class="bi bi-file-earmark-text me-1"></i>{{ $course->devoirs_count }} devoir{{ $course->devoirs_count > 1 ? 's' : '' }}
                        </span>
                    </div>
    ...
    <div class="text-center py-10">
        ...
        <h3 class="text-muted mb-3">Aucun cours disponible</h3>
        <p class="text-muted mb-4">Aucun cours n\'est encore disponible pour cette classe et matière.</p>
<a href="{{ route('student.subjects.index') }}" class="btn btn-outline-primary btn-lg">
