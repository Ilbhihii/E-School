...
<div class="adm-page-header">
    ...
    <div class="page-actions">
        <a href="{{ route('prof.levels.index') }}" class="adm-btn adm-btn-ghost">
...
@if($classes->isEmpty())
    <div class="adm-card">
        <div class="adm-empty" style="padding:4rem 2rem;">
            ...
            <p>Les classes seront disponibles une fois configurées par l'administration.</p>
        </div>
    </div>
@else
    <div class="row g-4">
        @foreach($classes as $class)
            ...
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('prof.levels.subjects', [$level, $class]) }}" class="text-decoration-none">
