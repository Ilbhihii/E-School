...
@section('title', 'Prendre rendez-vous pour un test')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <div class="text-center mb-5">
                    ...
                    <h2 class="section-title-3d">Prenez rendez-vous</h2>
                    <p class="text-white-50" style="max-width: 450px; margin: 0 auto;">
                        Laissez-nous vos coordonnées pour passer un test de niveau gratuit. Nous vous contacterons pour fixer un rendez-vous.
                    </p>
                </div>
